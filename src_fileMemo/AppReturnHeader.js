        ...
        <div id={style.contents}>
            <div className = {style.container}>
                <form method="post" enctype="multipart/form-data">
                  <label className = {style.label} id={style.label} for="input">
                    <div class={style.inner} id={style.inner}>드래그하거나 클릭해서 업로드</div>
                  </label>
                  <input id={style.input} className = {style.input} accept="image/*" type="file" name="chooseFile" required="true" multiple="true" hidden="true" onChange={loadFile(this)}/>
                  <div className={style.preview} id={style.preview}></div>
                </form>
            </div>
        </div>
